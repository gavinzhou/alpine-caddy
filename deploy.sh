...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-caddy:${tag}" "asia.gcr.io/orange-sys/alpine-caddy:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-caddy:${tag}
